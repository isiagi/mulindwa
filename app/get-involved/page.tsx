            ...
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="mx-auto max-w-[700px] text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                  Every contribution makes a difference in the lives of those we
                  serve.
                </p>
              </div>
            </div>
            ...
            <AnimateOnScroll variant="fade-up" duration={700} delay={100}>
              <div className="flex flex-col items-center space-y-2 rounded-lg bg-[#f4f4f4] p-6 shadow-lg">
                ...
                <p className="text-center text-gray-500">
                  Support our programs with a one-time or recurring donation.
                </p>
              ...
              <div className="flex flex-col justify-center space-y-4">
                <div className="space-y-2">
                  ...
                  <p className="text-gray-700 md:text-lg">
                    Your donation helps us continue our mission to empower
                    vulnerable individuals in Uganda. Every contribution, no
                  ...
                  <div className="rounded-lg border bg-white p-6 shadow-sm">
                    ...
                    <ul className="space-y-3">
                      <li className="flex items-start gap-2">
                        ...
                        <span>
                          $25 provides school supplies for a child for a term
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="text-[#8c3420] font-bold">•</span>
                        <span>
                          $50 supports healthcare for a family for a month
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="text-[#8c3420] font-bold">•</span>
                      ...
                      <li className="flex items-start gap-2">
                        <span className="text-[#8c3420] font-bold">•</span>
                        <span>
                          $250 helps build a water well for a community
                        </span>
                      </li>
                    </ul>
                  </div>
          ...
          <div className="grid gap-6 lg:grid-cols-2 lg:gap-12">
            ...
            >
              <div className="space-y-2">
                ...
                <p className="text-gray-700 md:text-lg">
                  Share your time, skills, and passion to make a difference in
                  the lives of vulnerable individuals in Uganda. We offer
                  various volunteer opportunities both locally and
                  internationally.
                </p>
              </div>
              <div className="space-y-4">
                <div className="rounded-lg border bg-[#f4f4f4] p-4 shadow-sm">
                  ...
                  <p className="mt-2 text-gray-700">
                    Join us in Uganda to support our programs and services
                ...
                <div className="rounded-lg border bg-[#f4f4f4] p-4 shadow-sm">
                  ...
                  <p className="mt-2 text-gray-700">
                    Support our work from anywhere in the world through virtual
          ...
          <AnimateOnScroll variant="fade-up" duration={700}>
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="mx-auto max-w-[700px] text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                  Join forces with Mulindwa Charity Foundation to create lasting
                  impact in Uganda.
                </p>
              </div>
            </div>
          ...
          <div className="mx-auto grid max-w-5xl gap-6 py-12 md:grid-cols-2 lg:grid-cols-3">
            <AnimateOnScroll variant="fade-up" duration={700} delay={100}>
              <div className="flex flex-col space-y-3 rounded-lg bg-white p-6 shadow-md">
                ...
                <p className="flex-1 text-gray-700">
                  Partner with us as a business to support our programs through
                  financial contributions, in-kind donations, or employee
                  volunteer programs.
                </p>
                <Link href="/contact">
            ...
            <AnimateOnScroll variant="fade-up" duration={700} delay={200}>
              <div className="flex flex-col space-y-3 rounded-lg bg-white p-6 shadow-md">
                ...
                <p className="flex-1 text-gray-700">
                  Collaborate with us as a non-profit organization to implement
                  joint programs, share resources, and maximize our collective
                  impact.
                </p>
                <Link href="/contact">
                  <Button className="w-full bg-[#8c3420] hover:bg-[#6a2718] text-white">
            ...
            <AnimateOnScroll variant="fade-up" duration={700} delay={300}>
              <div className="flex flex-col space-y-3 rounded-lg bg-white p-6 shadow-md">
                ...
                <p className="flex-1 text-gray-700">
                  Partner with us as an educational institution for research,
                  internships, and service-learning opportunities for students.
                </p>
                <Link href="/contact">
                  <Button className="w-full bg-[#8c3420] hover:bg-[#6a2718] text-white">
                    Learn More
            ...
            <AnimateOnScroll variant="fade-right" duration={800}>
              <div className="flex flex-col justify-center space-y-4">
                <div className="space-y-2">
                  ...
                  <p className="text-gray-700 md:text-lg">
                    Create your own fundraising campaign to support our work.
                    Whether it's a birthday, marathon, or special event, you can
                    turn it into an opportunity to make a difference.
                  </p>
                </div>
                <div className="space-y-4">
                  <div className="rounded-lg border bg-[#f4f4f4] p-4 shadow-sm">
            ...
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="mx-auto max-w-[700px] text-white/80 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                  Join us in our mission to empower vulnerable individuals in
                  Uganda. Every contribution, no matter how small, makes a
                  difference.
                </p>
              </div>
